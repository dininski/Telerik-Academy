var DrawChart = function (chartTitles, fromMonth, toMonth, year) {
    ...
    for (var i = fromMonth; i <= toMonth; i++) {
        var dataObject = createChartObject(i, year, homeBudget.getIncomes(monthParser(i), year) ||
            0, homeBudget.getExpenses(monthParser(i), year) ||
            0, homeBudget.getBudget(monthParser(i), year) || 0);
