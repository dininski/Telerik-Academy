            ...
            var enableSelection = function (data) {
                ...
                if (self.persister.nickname() === currentPlayerName) {
                    $('.' + currentPlayerTurn).on('click', function () {
                        ...
                        var subMenu = "<div id='movementMenu'>" +
                        ...
                        $(selector).after(subMenu);

                        $('body').on('click', '#defend', function () {
                            var id = $('.selected').data('element-id');
                            
                            self.persister.battle.defend(gameId, id, function () {
                                ui.setFlash("Defending");
                            }, function (data) {
                                ui.setFlash(data.responseJSON.Message.toString(), "err");
                            });
                        })

                        //self.persister.battle.defend(data.gameId, currentId, function () {
                        //    ui.setFlash("Defending");
                        //}, function (data) {
                        //    ui.setFlash(data.responseJSON.Message.toString(), "err");
                        //});
